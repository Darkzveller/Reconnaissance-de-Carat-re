...
from PIL import Image, ImageDraw, ImageFont
import keyboard
from pyvirtualdisplay import Display  # Importer Display depuis pyvirtualdisplay
import os

# Créer une instance de Display
...
from pyvirtualdisplay import Display  # Importer Display depuis pyvirtualdisplay
import os
import pyautogui  # Importer pyautogui

# Créer une instance de Display
display = Display(visible=0, size=(800, 600))
display.start()

# Définir la variable d'environnement DISPLAY en tant que chaîne de caractères
